...
public abstract class Rectangle {
	...
	float mPosX; // 位置
	float mPosY;
	private final float mScale; // 缩放
	private final float[] mVertices; // 顶点
	...
	Rectangle(float[] vertices, float scale, float[] colors, float posX, float posY) {
		mVertices = vertices;
		mColors = colors;
		mScale = scale;
		setPosX(posX);
	...
	public String toString() {
		return TAG + " form, PosX: " + getPosX() + ", PosY: " + getPosY();
	}
